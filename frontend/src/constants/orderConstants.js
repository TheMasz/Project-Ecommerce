...
export const ORDER_SELL_LIST_REQUEST = "ORDER_SELL_LIST_REQUEST";
export const ORDER_SELL_LIST_SUCCESS = "ORDER_SELL_LIST_SUCCESS";
export const ORDER_SELL_LIST_FAIL = "ORDER_SELL_LIST_FAIL";

export const ORDER_SELL_DETAIL_REQUEST = "ORDER_SELL_DETAIL_REQUEST";
export const ORDER_SELL_DETAIL_SUCCESS = "ORDER_SELL_DETAIL_SUCCESS";
export const ORDER_SELL_DETAIL_FAIL = "ORDER_SELL_DETAIL_FAIL";
...
export const ORDER_ISPAID_SUCCESS = 'ORDER_ISPAID_SUCCESS';
export const ORDER_ISPAID_FAIL = 'ORDER_ISPAID_FAIL';
export const ORDER_ISPAID_RESET = 'ORDER_ISPAID_RESET';
