...
export const PRODUCT_SHOWLIST_REQUEST = 'PRODUCT_SHOWLIST_REQUEST';
export const PRODUCT_SHOWLIST_SUCCESS = 'PRODUCT_SHOWLIST_SUCCESS';
export const PRODUCT_SHOWLIST_FAIL = 'PRODUCT_SHOWLIST_FAIL';
